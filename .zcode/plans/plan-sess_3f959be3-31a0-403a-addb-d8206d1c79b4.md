...
### 3. 牌型引擎（rule/，核心）
- CardType：三王炸/火箭/炸弹/含花牌炸弹/单/对/三张/三带一/三带二/单顺/连对/飞机/飞机带翅/四带二/PASS
- 经典识别：频次统计+连续性校验（顺子≥5、连对≥3、飞机≥2，不含2与王）
- 花牌：枚举替换值(3~17)记录所有合法解读；F+大小王=三王炸、F+三张=含花牌炸弹优先；压制用"存在任一解读能压过"语义，多解读按 三王炸>含花牌炸弹/炸弹>最大key 确定性选优
- 边界：F单出=单牌(大王值)；F+王=对王（提纲允许）；四带二不互压；顺子等长；等值不能压
- 炸弹/火箭/三王炸/含花牌炸弹当场倍数×2 并广播
